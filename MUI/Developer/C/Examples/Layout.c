...
SAVEDS ULONG __asm LayoutFunc(REG(a0) struct Hook *h,REG(a2) Object *obj,REG(a1) struct MUI_LayoutMsg *lm)
{
	switch (lm->lm_Type)
	{
		case MUILM_MINMAX:
...
SAVEDS ULONG __asm PressFunc(REG(a0) struct Hook *h,REG(a2) Object *app,REG(a1) ULONG *num)
{
...
int main(int argc,char *argv[])
{
	...
	app = ApplicationObject,
		...
		MUIA_Application_Version    , "$VER: Layout 19.5 (12.02.97)",
